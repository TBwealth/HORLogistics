...
@Component({
  selector: 'app-riderroute',
  templateUrl: './riderroute.page.html',
  styleUrls: ['./riderroute.page.scss'],
})
export class RiderroutePage implements OnInit {
  addressStart: any;
  addressEnd: any;
  mapHeight: any;
  mapType: any;
      ...
      constructor(private navCtrl: NavController, 
        ...
        private maproute: MaprouteService) { 
          ...
          this.platform.ready().then(()=>{
            this.mapType = this.maproute.mapType;

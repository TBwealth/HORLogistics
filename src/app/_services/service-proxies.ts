...
export class AccountServiceProxy {
     ...
     * @return OK
     */
    login(payload: LoginDTO): Observable<ObjectResourceOfLoginResource> {
...
export class ApiServiceProxy {
     ...
     * @return OK
     */
    payment(usr: VmUserObj): Observable<boolean> {
    ...
    protected processPayment(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class AdminServiceProxy {
     ...
     * @return OK
     */
    createRider(payload: CreateRider): Observable<StatusResource> {
        let url_ = this.baseUrl + "/api/Admin/CreateRider";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateRider(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateRider(<any>response_);
                } catch (e) {
                    return <Observable<StatusResource>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateRider(response: HttpResponseBase): Observable<StatusResource> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return OK
     */
    createwallet(payload: CreateWallet): Observable<StatusResource> {
        let url_ = this.baseUrl + "/api/Admin/Createwallet";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreatewallet(<any>response_);
                } catch (e) {
                    return <Observable<StatusResource>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreatewallet(response: HttpResponseBase): Observable<StatusResource> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return OK
     */
    updateWallet(payload: CreateWallet): Observable<StatusResource> {
        let url_ = this.baseUrl + "/api/Admin/UpdateWallet";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdateWallet(response: HttpResponseBase): Observable<StatusResource> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return OK
     */
    getwallettops(page: number): Observable<ObjectResourceOfTopUps> {
        let url_ = this.baseUrl + "/api/Admin/getwallettops?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetwallettops(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetwallettops(<any>response_);
                } catch (e) {
                    return <Observable<ObjectResourceOfTopUps>><any>_observableThrow(e);
                }
            } else
                return <Observable<ObjectResourceOfTopUps>><any>_observableThrow(response_);
        }));
    }

    protected processGetwallettops(response: HttpResponseBase): Observable<ObjectResourceOfTopUps> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ObjectResourceOfTopUps.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ObjectResourceOfTopUps>(<any>null);
    }

    /**
     * @return OK
     */
    topwallet(topUp: TopWallet): Observable<StatusResource> {
        let url_ = this.baseUrl + "/api/Admin/Topwallet";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(topUp);
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTopwallet(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTopwallet(<any>response_);
                } catch (e) {
                    return <Observable<StatusResource>><any>_observableThrow(e);
                }
            } else
    ...
    protected processTopwallet(response: HttpResponseBase): Observable<StatusResource> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return OK
     */
    reviewRiderDoc(riderId: number): Observable<ObjectResourceOfDispatcher> {
        let url_ = this.baseUrl + "/api/Admin/ReviewRiderDoc?";
        if (riderId === undefined || riderId === null)
            throw new Error("The parameter 'riderId' must be defined and cannot be null.");
        else
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processReviewRiderDoc(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processReviewRiderDoc(<any>response_);
                } catch (e) {
                    return <Observable<ObjectResourceOfDispatcher>><any>_observableThrow(e);
                }
            } else
                return <Observable<ObjectResourceOfDispatcher>><any>_observableThrow(response_);
        }));
    }

    protected processReviewRiderDoc(response: HttpResponseBase): Observable<ObjectResourceOfDispatcher> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ObjectResourceOfDispatcher.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ObjectResourceOfDispatcher>(<any>null);
    }

    /**
     * @return OK
     */
    approveRider(riderId: number): Observable<ObjectResourceOfDispatcher> {
        let url_ = this.baseUrl + "/api/Admin/ApproveRider?";
        if (riderId === undefined || riderId === null)
            throw new Error("The parameter 'riderId' must be defined and cannot be null.");
        else
            url_ += "riderId=" + encodeURIComponent("" + riderId) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processApproveRider(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processApproveRider(<any>response_);
                } catch (e) {
                    return <Observable<ObjectResourceOfDispatcher>><any>_observableThrow(e);
                }
            } else
    ...
    protected processApproveRider(response: HttpResponseBase): Observable<ObjectResourceOfDispatcher> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return OK
     */
    getallriderGet(statusId: number, pageNumber: number): Observable<ObjectResourceOfRiders> {
        let url_ = this.baseUrl + "/api/Admin/getallrider?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetallriderGet(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetallriderGet(<any>response_);
                } catch (e) {
                    return <Observable<ObjectResourceOfRiders>><any>_observableThrow(e);
                }
            } else
                return <Observable<ObjectResourceOfRiders>><any>_observableThrow(response_);
        }));
    }

    protected processGetallriderGet(response: HttpResponseBase): Observable<ObjectResourceOfRiders> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ObjectResourceOfRiders.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ObjectResourceOfRiders>(<any>null);
    }

    /**
     * @return OK
     */
    getallriderPost(payload: CreatePenalty): Observable<StatusResource> {
        let url_ = this.baseUrl + "/api/Admin/getallrider";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetallriderPost(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetallriderPost(<any>response_);
                } catch (e) {
                    return <Observable<StatusResource>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetallriderPost(response: HttpResponseBase): Observable<StatusResource> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class LocalBookingServiceProxy {
    ...
    /**
     * @param payload_bookingNumber (optional) 
     * @return OK
     */
    updatedeliverydate(payload_deliveryDate: Date, payload_bookingNumber: number | null | undefined): Observable<StatusResource> {
        let url_ = this.baseUrl + "/api/LocalBooking/Updatedeliverydate?";
        if (payload_deliveryDate === undefined || payload_deliveryDate === null)
            throw new Error("The parameter 'payload_deliveryDate' must be defined and cannot be null.");
        else
            url_ += "payload.deliveryDate=" + encodeURIComponent(payload_deliveryDate ? "" + payload_deliveryDate.toJSON() : "") + "&";
        if (payload_bookingNumber !== undefined && payload_bookingNumber !== null)
            url_ += "payload.bookingNumber=" + encodeURIComponent("" + payload_bookingNumber) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdatedeliverydate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdatedeliverydate(<any>response_);
                } catch (e) {
                    return <Observable<StatusResource>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdatedeliverydate(response: HttpResponseBase): Observable<StatusResource> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class LocationsServiceProxy {
     ...
     * @return OK
     */
    getLocationinstate(stateId: number): Observable<ListResourceOfLocation> {
        let url_ = this.baseUrl + "/api/locations/GetLocationinstate?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetLocationinstate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetLocationinstate(<any>response_);
                } catch (e) {
                    return <Observable<ListResourceOfLocation>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResourceOfLocation>><any>_observableThrow(response_);
        }));
    }

    protected processGetLocationinstate(response: HttpResponseBase): Observable<ListResourceOfLocation> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ListResourceOfLocation.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResourceOfLocation>(<any>null);
    }

    /**
     * @return OK
     */
    getOfficeState(): Observable<ListResourceOfResidentialState> {
        let url_ = this.baseUrl + "/api/locations/GetOfficeState";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetOfficeState(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetOfficeState(<any>response_);
                } catch (e) {
                    return <Observable<ListResourceOfResidentialState>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResourceOfResidentialState>><any>_observableThrow(response_);
        }));
    }

    protected processGetOfficeState(response: HttpResponseBase): Observable<ListResourceOfResidentialState> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ListResourceOfResidentialState.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResourceOfResidentialState>(<any>null);
    }

    /**
     * @return OK
     */
    getlocationbyid(id: number): Observable<ObjectResourceOfLocation> {
        let url_ = this.baseUrl + "/api/locations/getlocationbyid?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined and cannot be null.");
        else
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ObjectResourceOfLocation>><any>_observableThrow(e);
                }
            } else
                return <Observable<ObjectResourceOfLocation>><any>_observableThrow(response_);
        }));
    }

    protected processGetlocationbyid(response: HttpResponseBase): Observable<ObjectResourceOfLocation> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ObjectResourceOfLocation.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ObjectResourceOfLocation>(<any>null);
    }
}
...
export class PaymentServiceProxy {
     ...
     * @return OK
     */
    initialize(payload: PaymentValidationDTO): Observable<StatusResource> {
        let url_ = this.baseUrl + "/api/payment/initialize";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processInitialize(response: HttpResponseBase): Observable<StatusResource> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return OK
     */
    validatePayment(dTO: PaymentValidationDTO): Observable<StatusResource> {
        let url_ = this.baseUrl + "/api/payment/ValidatePayment";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processValidatePayment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processValidatePayment(<any>response_);
                } catch (e) {
                    return <Observable<StatusResource>><any>_observableThrow(e);
                }
            } else
    ...
    protected processValidatePayment(response: HttpResponseBase): Observable<StatusResource> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CountriesServiceProxy {
     ...
     * @return OK
     */
    getStatebyId(id: number): Observable<ObjectResourceOfResidentialState> {
        let url_ = this.baseUrl + "/api/countries/getStatebyId?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined and cannot be null.");
        else
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ObjectResourceOfResidentialState>><any>_observableThrow(e);
                }
            } else
                return <Observable<ObjectResourceOfResidentialState>><any>_observableThrow(response_);
        }));
    }

    protected processGetStatebyId(response: HttpResponseBase): Observable<ObjectResourceOfResidentialState> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ObjectResourceOfResidentialState.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ObjectResourceOfResidentialState>(<any>null);
    }
}
...
export class RiderServiceProxy {
     ...
     * @return OK
     */
    riderDocuments(payload: RiderDocument): Observable<StatusResource> {
     ...
     * @return OK
     */
    updateriderstatusbyadmin(payload: UpdateRiderByAdmin): Observable<StatusResource> {
        let url_ = this.baseUrl + "/api/Rider/Updateriderstatusbyadmin";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateriderstatusbyadmin(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateriderstatusbyadmin(<any>response_);
                } catch (e) {
                    return <Observable<StatusResource>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateriderstatusbyadmin(response: HttpResponseBase): Observable<StatusResource> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return OK
     */
    issueQuery(payload: IssueQuery): Observable<StatusResource> {
        let url_ = this.baseUrl + "/api/Rider/IssueQuery";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processIssueQuery(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processIssueQuery(<any>response_);
                } catch (e) {
                    return <Observable<StatusResource>><any>_observableThrow(e);
                }
            } else
    ...
    protected processIssueQuery(response: HttpResponseBase): Observable<StatusResource> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return OK
     */
    getdeliveredOrder(filter_dispatcherId: number, filter_date_range: string | null | undefined, filter_pageNumber: number | null | undefined): Observable<ObjectResourceOfOrders> {
        let url_ = this.baseUrl + "/api/Rider/getdeliveredOrder?";
        if (filter_dispatcherId === undefined || filter_dispatcherId === null)
            throw new Error("The parameter 'filter_dispatcherId' must be defined and cannot be null.");
        else
            url_ += "filter.dispatcherId=" + encodeURIComponent("" + filter_dispatcherId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetdeliveredOrder(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetdeliveredOrder(<any>response_);
                } catch (e) {
                    return <Observable<ObjectResourceOfOrders>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetdeliveredOrder(response: HttpResponseBase): Observable<ObjectResourceOfOrders> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return OK
     */
    markorderasreceived(payload: MarkOrderAsRecieved): Observable<StatusResource> {
        let url_ = this.baseUrl + "/api/Rider/markorderasreceived";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processMarkorderasreceived(<any>response_);
                } catch (e) {
                    return <Observable<StatusResource>><any>_observableThrow(e);
                }
            } else
    ...
    protected processMarkorderasreceived(response: HttpResponseBase): Observable<StatusResource> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class Dispatcher implements IDispatcher {
    ...
    dispatcherPenalty: DispatcherPenalty[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["dispatcherPenalty"])) {
                this.dispatcherPenalty = [] as any;
                for (let item of _data["dispatcherPenalty"])
                    this.dispatcherPenalty.push(DispatcherPenalty.fromJS(item));
            }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.dispatcherPenalty)) {
            data["dispatcherPenalty"] = [];
            for (let item of this.dispatcherPenalty)
                data["dispatcherPenalty"].push(item.toJSON());
        }
...
export class LocalBooking implements ILocalBooking {
    ...
    receivedOrderPicture: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.receivedOrderPicture = _data["receivedOrderPicture"];
    ...
    toJSON(data?: any) {
        ...
        data["receivedOrderPicture"] = this.receivedOrderPicture;
...
export class DispatcherPenalty implements IDispatcherPenalty {
    id: number | undefined;
    dispatcherId: number | undefined;
    ...
    topUpPenalty: TopUpPenalty[] | undefined;

    constructor(data?: IDispatcherPenalty) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.noOfMonths = _data["noOfMonths"];
            this.createdAt = _data["createdAt"] ? new Date(_data["createdAt"].toString()) : <any>undefined;
            this.updatedAt = _data["updatedAt"] ? new Date(_data["updatedAt"].toString()) : <any>undefined;
            this.dispatcher = _data["dispatcher"] ? Dispatcher.fromJS(_data["dispatcher"]) : <any>undefined;
            this.ispaymentCompleted = _data["ispaymentCompleted"];
            if (Array.isArray(_data["topUpPenalty"])) {
                this.topUpPenalty = [] as any;
                for (let item of _data["topUpPenalty"])
                    this.topUpPenalty.push(TopUpPenalty.fromJS(item));
            }
        }
    }

    static fromJS(data: any): DispatcherPenalty {
        data = typeof data === 'object' ? data : {};
        let result = new DispatcherPenalty();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.topUpPenalty)) {
            data["topUpPenalty"] = [];
            for (let item of this.topUpPenalty)
                data["topUpPenalty"].push(item.toJSON());
        }
        return data; 
    }

    clone(): DispatcherPenalty {
        const json = this.toJSON();
        let result = new DispatcherPenalty();
        result.init(json);
        return result;
...
export interface IDispatcherPenalty {
    id: number | undefined;
    dispatcherId: number | undefined;
    amount: number | undefined;
    reason: string | undefined;
...
export class TopUpPenalty implements ITopUpPenalty {
    id: number | undefined;
    dispatcherPenaltyId: number | undefined;
    amount: number | undefined;
    amountBeforeTopUp: number | undefined;
    penaltyAmount: number | undefined;
    amountAfterTopUp: number | undefined;
    dispatcherId: number | undefined;
    monthPaid: Date | undefined;
    createdAt: Date | undefined;
    updatedAt: Date | undefined;
    dispatcherPenalty: DispatcherPenalty | undefined;

    constructor(data?: ITopUpPenalty) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.dispatcherPenaltyId = _data["dispatcherPenaltyId"];
            this.amount = _data["amount"];
            this.amountBeforeTopUp = _data["amountBeforeTopUp"];
            this.penaltyAmount = _data["penaltyAmount"];
            this.amountAfterTopUp = _data["amountAfterTopUp"];
            this.dispatcherId = _data["dispatcherId"];
            this.monthPaid = _data["monthPaid"] ? new Date(_data["monthPaid"].toString()) : <any>undefined;
            this.createdAt = _data["createdAt"] ? new Date(_data["createdAt"].toString()) : <any>undefined;
            this.updatedAt = _data["updatedAt"] ? new Date(_data["updatedAt"].toString()) : <any>undefined;
            this.dispatcherPenalty = _data["dispatcherPenalty"] ? DispatcherPenalty.fromJS(_data["dispatcherPenalty"]) : <any>undefined;
        }
    }

    static fromJS(data: any): TopUpPenalty {
        data = typeof data === 'object' ? data : {};
        let result = new TopUpPenalty();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
        data["dispatcherPenaltyId"] = this.dispatcherPenaltyId;
        data["amount"] = this.amount;
        data["amountBeforeTopUp"] = this.amountBeforeTopUp;
        data["penaltyAmount"] = this.penaltyAmount;
        data["amountAfterTopUp"] = this.amountAfterTopUp;
        data["dispatcherId"] = this.dispatcherId;
        data["monthPaid"] = this.monthPaid ? this.monthPaid.toISOString() : <any>undefined;
        data["createdAt"] = this.createdAt ? this.createdAt.toISOString() : <any>undefined;
        data["updatedAt"] = this.updatedAt ? this.updatedAt.toISOString() : <any>undefined;
        data["dispatcherPenalty"] = this.dispatcherPenalty ? this.dispatcherPenalty.toJSON() : <any>undefined;
        return data; 
    }
...
export interface ITopUpPenalty {
    id: number | undefined;
    dispatcherPenaltyId: number | undefined;
    amount: number | undefined;
    amountBeforeTopUp: number | undefined;
...
export class CreateRider implements ICreateRider {
    email: string;
    phoneNumber: string | undefined;
    sponsorName: string | undefined;
    sponsorAddress: string | undefined;
    ...
    static fromJS(data: any): CreateRider {
        data = typeof data === 'object' ? data : {};
        let result = new CreateRider();
        result.init(data);
        return result;
    }
...
export class CreateWallet implements ICreateWallet {
    ...
    constructor(data?: ICreateWallet) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateWallet {
        data = typeof data === 'object' ? data : {};
        let result = new CreateWallet();
        result.init(data);
        return result;
    }
...
export class ObjectResourceOfTopUps implements IObjectResourceOfTopUps {
    data: TopUps | undefined;
    code: string | undefined;
    message: string | undefined;

    constructor(data?: IObjectResourceOfTopUps) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.data = _data["data"] ? TopUps.fromJS(_data["data"]) : <any>undefined;
            this.code = _data["code"];
            this.message = _data["message"];
        }
    }

    static fromJS(data: any): ObjectResourceOfTopUps {
        data = typeof data === 'object' ? data : {};
        let result = new ObjectResourceOfTopUps();
        result.init(data);
        return result;
    }
...
export interface IObjectResourceOfTopUps {
    data: TopUps | undefined;
    code: string | undefined;
    message: string | undefined;
}

export class TopUps implements ITopUps {
    walletTops: WalletTopUp[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["walletTops"])) {
                this.walletTops = [] as any;
                for (let item of _data["walletTops"])
                    this.walletTops.push(WalletTopUp.fromJS(item));
            }
    ...
    static fromJS(data: any): TopUps {
        data = typeof data === 'object' ? data : {};
        let result = new TopUps();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (Array.isArray(this.walletTops)) {
            data["walletTops"] = [];
            for (let item of this.walletTops)
                data["walletTops"].push(item.toJSON());
        }
...
export class WalletTopUp implements IWalletTopUp {
    id: number | undefined;
    walletId: string | undefined;
    amount: number | undefined;
    createdAt: Date | undefined;
    ...
    static fromJS(data: any): WalletTopUp {
        data = typeof data === 'object' ? data : {};
        let result = new WalletTopUp();
        result.init(data);
        return result;
    }
...
export class TopWallet implements ITopWallet {
    walletId: string | undefined;
    amount: number | undefined;

    constructor(data?: ITopWallet) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TopWallet {
        data = typeof data === 'object' ? data : {};
        let result = new TopWallet();
        result.init(data);
        return result;
    }
...
export class ObjectResourceOfDispatcher implements IObjectResourceOfDispatcher {
    data: Dispatcher | undefined;
    code: string | undefined;
    message: string | undefined;

    constructor(data?: IObjectResourceOfDispatcher) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.data = _data["data"] ? Dispatcher.fromJS(_data["data"]) : <any>undefined;
            this.code = _data["code"];
            this.message = _data["message"];
        }
    }

    static fromJS(data: any): ObjectResourceOfDispatcher {
        data = typeof data === 'object' ? data : {};
        let result = new ObjectResourceOfDispatcher();
        result.init(data);
        return result;
    }
    ...
    clone(): ObjectResourceOfDispatcher {
        const json = this.toJSON();
        let result = new ObjectResourceOfDispatcher();
        result.init(json);
        return result;
...
export interface IObjectResourceOfDispatcher {
    data: Dispatcher | undefined;
    code: string | undefined;
    message: string | undefined;
}

export class ObjectResourceOfRiders implements IObjectResourceOfRiders {
    data: Riders | undefined;
    code: string | undefined;
    message: string | undefined;

    constructor(data?: IObjectResourceOfRiders) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.data = _data["data"] ? Riders.fromJS(_data["data"]) : <any>undefined;
            this.code = _data["code"];
            this.message = _data["message"];
        }
    }

    static fromJS(data: any): ObjectResourceOfRiders {
        data = typeof data === 'object' ? data : {};
        let result = new ObjectResourceOfRiders();
        result.init(data);
        return result;
    }
...
export interface IObjectResourceOfRiders {
    data: Riders | undefined;
    code: string | undefined;
    message: string | undefined;
}

export class Riders implements IRiders {
    dispatcher: Dispatcher[] | undefined;
    totalCount: number | undefined;
    totalPages: number | undefined;
    currentPage: number | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["dispatcher"])) {
                this.dispatcher = [] as any;
                for (let item of _data["dispatcher"])
                    this.dispatcher.push(Dispatcher.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
            this.totalPages = _data["totalPages"];
            this.currentPage = _data["currentPage"];
    ...
    static fromJS(data: any): Riders {
        data = typeof data === 'object' ? data : {};
        let result = new Riders();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (Array.isArray(this.dispatcher)) {
            data["dispatcher"] = [];
            for (let item of this.dispatcher)
                data["dispatcher"].push(item.toJSON());
        }
        data["totalCount"] = this.totalCount;
        data["totalPages"] = this.totalPages;
        data["currentPage"] = this.currentPage;
...
export class CreatePenalty implements ICreatePenalty {
    amount: number;
    reason: string;
    dispatcherId: number;
    issuerId: string | undefined;
    ...
    constructor(data?: ICreatePenalty) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreatePenalty {
        data = typeof data === 'object' ? data : {};
        let result = new CreatePenalty();
        result.init(data);
        return result;
    }
...
export interface ICreatePenalty {
    amount: number;
    reason: string;
    dispatcherId: number;
    issuerId: string | undefined;
...
export class UpdateDeliveryDate implements IUpdateDeliveryDate {
    ...
    constructor(data?: IUpdateDeliveryDate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateDeliveryDate {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateDeliveryDate();
        result.init(data);
        return result;
    }
...
export class UserViewModel implements IUserViewModel {
    ...
    totalDispatcher: number | undefined;
    totalParneter: number | undefined;
    totalCustomer: number | undefined;
    dispatcherDocument: DispatcherDocument | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.totalDispatcher = _data["totalDispatcher"];
            this.totalParneter = _data["totalParneter"];
    ...
    toJSON(data?: any) {
        ...
        data["totalDispatcher"] = this.totalDispatcher;
        data["totalParneter"] = this.totalParneter;
